...
export const FAQ = () => {
    ...
    return (
        <>
            <div className='max-w-[1056px] space-around mx-auto text-center mt-[100px] sm:mt-[90px] xl:-mt-[400px] '>
                <h1 className='text-[44px] sm:text-[64px]'>FREQUENTLY ASKED QUESTIONS</h1>
            </div>
            <div className="p-4">
