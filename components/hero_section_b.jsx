        ...
        <>
            <div className='flex flex-wrap relative max-w-[1318px] mx-auto'>
                ...
                <div className='hidden sm:hidden lg:flex'>
                    <button className='absolute w-[40px] px-[8px] text-[#fff] h-[40px] rounded bg-gradient-to-r from-[#FD0000] to-[#FF9292] z-[1] bottom-[38px] left-[190px] lg:left-[840px] xl:left-[1140px] rotate-45'>
                        <img src={Left_arrow} alt="" className='-rotate-45' />
                    </button>
                    <button className='absolute w-[40px] px-[8px] text-[#fff] h-[40px] rounded bg-gradient-to-r from-[#FD0000] to-[#FF9292] z-[1] bottom-[38px] left-[1250px] lg:left-[900px] xl:left-[1200px] rotate-45'>
            ...
            {/* Cards Grid */}
            <div className='sm:flex sm:flex-wrap gap-2 pt-[40px] max-w-[1318px] mx-auto lg:justify-between justify-around'>
