    ...
    return (
        <>
            <div className='max-w-[819px] mx-auto space-around pt-[90px] text-center '>
                <h1 className='text-[44px] sm:text-[64px]'>Ready for Next NFT Drop?</h1>
                <div className=' relative mt-[4vh]'>
                    <input type="text" placeholder="info@gmail.com" class="w-[280px] sm:w-[580px] lg:w-[680px] h-[90px]  bg-[#fff] shadow-md p-3 border-2 border-red-300 rounded-lg focus:outline-none {/*focus:ring-2 focus:ring-blue-500 focus:border-blue-500*/}" />
                    <button className=' absolute left-[230px] bottom-[6px] sm:left-[500px] md:left-[560px] lg:left-[630px] sm:bottom-[6px] lg:bottom-[5px] w-[88px] h-[76px] text-white rounded-md bg-gradient-to-r from-[#FD0000] to-[#FF9292]'> <Send className="w-[32px] h-[32px] text-white ml-[27px]" />
                    </button>
                </div>
            </div>
            {/* lg:ml-45 md:mx-8 */}
            <div className=' max-w-[1320px] h-[358px] bg-gradient-to-r from-[#FD0000] to-[#FF9292] justif-around mx-auto my-[50px] rounded-[20px] block lg:flex '>
                <img src={Traced} alt="" />
                <div className='text-white text-[20px] sm:ml-[120px] md:ml-[170px] lg:ml-[20px]  -mt-[230px] lg:mt-[80px]'>
                    <p>NFT ALGO is the world’s leading NFTs <br /> marketplace where you can discover, sell <br /> and bid NFTs and get rich </p>
                    <div className="flex gap-2 justify-left sm:space-x-4 pt-4">
                ...
                <div className='flex sm:flex sm:gap-3  lg:block lg:space-y-4 sm:ml-[90px] md:ml-[150px]  lg:ml-[20px] sm:mt-[10px] lg:mt-[50px]'>
