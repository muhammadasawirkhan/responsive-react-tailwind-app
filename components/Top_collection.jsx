...
export const Top_collection = () => {
    return (
        <>
            <div className='flex flex-wrap max-w-[1318px] lg:mx-auto sm:mx-[70px]  xl:px-[10px] py-[50px]  justify-between'>
                <div className='sm:ml-[0px] md:ml-[50px] lg:ml-[250px] xl:ml-[0px]'>
                    <h1 className='text-[64px] '>TOP COLLECTION</h1>
                </div>
                <div className='sm:ml-[0px] md:ml-[50px] lg:ml-[250px] xl:-mr-[60px]'>
                    <button className='text-[#FE0101] text-[22px] font-semibold my-[40px] sm:mx-[150px]'><a href="">View more Collection</a></button>
                </div>

            </div>
            <div className='flex flex-wrap gap-3 max-w-[1318px] lg:mx-auto sm:mx-[120px]  '>
                <div className='max-w-[417px] md:ml-[70px] xl:ml-[0px] max-h-[301px] bg-[#FFF9F9] px-[10px] py-[10px] rounded-[15px] shadow-2xl'>
                    <div className='bg-[#E7E7E7] py-[10px] px-[10px] rounded-[15px]'>
                        ...
                        <div className='flex gap-1 sm:gap-3 py-[10px]'>
                ...
                <div className='max-w-[417px] md:ml-[70px] lg:ml-[0px] max-h-[301px] bg-[#FFF9F9] px-[10px] py-[10px] rounded-[15px] shadow-2xl'>
                    <div className='bg-[#E7E7E7] py-[10px] px-[10px] rounded-[15px]'>
                        <div className='flex gap-1 sm:gap-3'>
                ...
                <div className='sm:max-w-[417px] md:ml-[70px] lg:ml-[285px] xl:ml-[0px] max-h-[301px] bg-[#FFF9F9] px-[10px] py-[10px] rounded-[15px] shadow-2xl'>
                    <div className='bg-[#E7E7E7] py-[10px] px-[10px] rounded-[15px]'>
                        <div className='flex gap-1 sm:gap-3'>
