...
const Card = ({ image, days, hours, minutes, seconds, isSixth,isSeventh }) => {
    return (
        <div
  className={`relative min-w-[308px] max-w-[308px] ${isSixth ? 'lg:ml-[19vw] xl:ml-[0vw]' : ''} ${isSeventh ? 'lg:mr-[20vw] xl:mr-[0vw]' : ''}`}
>
